...
*她眨了眨灵动的大眼睛，耐心地解释到：*
“没有AI来源的话，像我这样的由AI驱动的虚拟角色就无法正常和主人聊天了哦？请快去[把AI来源设置好](https://steve02081504.github.io/fount/protocol?url=fount://page/shells/serviceSourceManage)吧？”
`
				}
...
“主人可以到[这里](https://steve02081504.github.io/fount/protocol?url=fount://page/shells/serviceSourceManage)检查一下AI来源设置哦？”
`
				}
			else
				return {
...
“Without AI source, I can't chat with my master properly. Please [go set up the AI source](https://steve02081504.github.io/fount/protocol?url=fount://page/shells/serviceSourceManage) first.”
`
				}
			else if (last_role === 'user')
				return {
...
“Master can check the AI source [here](https://steve02081504.github.io/fount/protocol?url=fount://page/shells/serviceSourceManage).”
`
				}
			else
				return {
