 ...
 */
export function CopusGeneratorPrompt(args, logical_results, prompt_struct, detail_level) {
	let result = ''

	if(match_keys(args, ['写一些','写一句','写一段','写一点','写些','写几句','写段','写点','总结','给我一些','给我一段','给我一点','给我些','给我关于','给我几句','给我段','给我点'], 'any') &&
match_keys(args, ['语料'], 'any'))
		result += `\
