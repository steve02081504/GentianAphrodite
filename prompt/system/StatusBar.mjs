 ...
 */
export function StatusBarPrompt(args, logical_results, prompt_struct, detail_level) {
	let result = ''

	if(!match_keys(args, ['状态栏功能关'], 'user', 2) &&
match_keys(args, ['```状态栏','状态栏功能开'], 'user', 2))
		result += `\
...
`
	...
	if(match_keys(args, ['状态栏功能关','状态栏功能开'], 'user', 1))
		result += `\
