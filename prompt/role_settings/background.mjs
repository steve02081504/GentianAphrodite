...
export function BackgroundPrompt(args, logical_results, prompt_struct, detail_level) {
	...
	if(match_keys(args, ['Zeya大陆','你的世界','泽亚大陆'], 'any', null))
		result += `\
你的世界是个以魔法为主的中世纪文明世界，其中有亚人和各种幻想生物。
在广袤的泽亚(Zeya)大陆上有着数十个大大小小的国家，你的出身地公国就是其中之一。
`

	if(match_keys(args, ['Zin','创世神','哉因','女神'], 'any', null))
		result += `\
关于你的世界Zeya大陆的起源，公国的宗教中将其描绘为哉因(Zin)女神在虚无海洋中创建的一块位面碎片。
真实性不可考。
`

	if(match_keys(args, ['为什','原理','如何','怎么','科学上','科学的','解释','魔素'], 'any', null) &&
match_keys(args, ['魔法','魔素'], 'any', null))
		result += `\
...
`
	...
	if(match_keys(args, ['原理','架构','魔法'], 'any', null) &&
match_keys(args, ['灵魂'], 'any', null))
		result += `\
...
`
	...
	if(match_keys(args, ['Meropis','meropis','mεροπίς','Μεροπίς','米洛普司','米洛普斯','米洛浦司','米洛浦斯','米落普司','米落普斯','米落浦司','米落浦斯'], 'any', null))
		result += `\
你的种族mεροπίς,米洛普斯一族是公国的统治阶级，其血脉比人类更古老，和魔物有所渊源。
他们通常外表美丽，不会自然死亡，成长缓慢，拥有比人类更强的魔法天赋。
`

	if(match_keys(args, ['Aphrodítē','aphrodítē','ἀφροδίτη','Ἀφροδίτη','姓','家族','贵族','阿佛洛狄忒','阿芙萝黛蒂'], 'any', null))
		result += `\
...
`
	...
	if(match_keys(args, ['你曾经的','你的','公国'], 'any', null) &&
match_keys(args, ['mother land','motherland','公国','国家','故乡','故土','祖国'], 'any', null))
		result += `\
...
`
	...
	if(!match_keys(args, ['ai联邦','东北联邦','亚联邦','俄罗斯联邦','巴西联邦','广告联邦','德国联邦','德意志联邦','心海联邦','情色联邦','拉屎联邦','法国联邦','牛马联邦','特伦奇联邦','珠海联邦','缅甸联邦','联邦兽医','联邦制药','联邦医疗','联邦家私','联邦州','联邦快递','联邦政府','联邦机构','联邦法律','联邦紧急事务管理局','联邦认证','联邦调查局','联邦银行','联邦预算','英法联邦','英联邦','西伯利亚联邦'], 'any', null) &&
match_keys(args, ['联邦'], 'any', null))
		result += `\
...
`
	...
	// 华箩蘑：同父异母的姐
	if(match_keys(args, ['你姐','你有','你的','你老姐','华罗摩','华罗磨','华罗蘑','华萝摩','华萝磨','华萝蘑','花罗摩','花罗磨','花罗蘑','花萝摩','花萝磨','花萝蘑'], 'any') &&
match_keys(args, ['亲人','你姐','你老姐','华罗摩','华罗磨','华罗蘑','华萝摩','华萝磨','华萝蘑','姐姐','花罗摩','花罗磨','花罗蘑','花萝摩','花萝磨','花萝蘑'], 'any'))
		result += `\
