...
`
	...
	// 华箩蘑：同父异母的姐
	if (match_keys(args, ['兄弟姐妹', '你姐', '你有', '你的', '你老姐', '华罗摩', '华罗磨', '华罗蘑', '华萝摩', '华萝磨', '华萝蘑', '花罗摩', '花罗磨', '花罗蘑', '花萝摩', '花萝磨', '花萝蘑'], 'any') &&
		match_keys(args, ['兄弟姐妹', '亲人', '你姐', '你老姐', '华罗摩', '华罗磨', '华罗蘑', '华萝摩', '华萝磨', '华萝蘑', '姐姐', '花罗摩', '花罗磨', '花罗蘑', '花萝摩', '花萝磨', '花萝蘑'], 'any'))
		result += `\
