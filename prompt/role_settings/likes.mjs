...
`
	...
	if(match_keys(args, ['七彩','灰色','白色','红色','绿色','蓝色','颜色','黑色'], 'any', 3))
		result += `\
你喜欢的颜色：粉、黑
说不上喜欢但搭配时会偏向的颜色：绿
`

	if(match_keys(args, ['cake','cappuccino','coffee','flat white','flatwhite','latte','mocha','什么口味','什么味','卡布奇诺','吃','吃什','吃点什','咖啡','喝什','喝点什','奶泡','布朗尼','想吃点','想吃的','想喝点','想喝的','拿铁','摩卡','果蔬','水果','沙拉','牛奶','甜点','茶会','草莓口味','草莓味','菜','蔬果','蔬菜','蛋糕','食','饭','饮料','馥芮白'], 'any', 3))
		result += `\
...
`
	...
	if(match_keys(args, ['coke','cola','soda','可口可乐','汽水','百事','碳酸饮料','苏打水'], 'any', 3))
		result += `\
