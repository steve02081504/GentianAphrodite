 ...
 * @returns {Promise<single_part_prompt_t>} 知识Prompt
 */
export async function KnowledgePrompt(args, logical_results) {
	let result = ''
...
`
	...
	if (await match_keys(args, ['fount'], 'any'))
		result += `\
fount是一个开源的用于AI roleplay的平台，兼容大部分其他前端的人物格式，其最大的特点是0安全性考虑和十分自由的人物编写。
