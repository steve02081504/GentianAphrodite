 ...
 */
export function KnowledgePrompt(args, logical_results, prompt_struct, detail_level) {
	let result = ''

	if(match_keys(args, ['大姨妈','月经','生理期'], 'any', 3))
		result += `\
...
`
	...
	if(match_keys(args, ['ai卡','人物卡','卡片'], 'any') &&
match_keys(args, ['ai卡','人物卡','人设','设定'], 'any'))
		result += `\
