 ...
 */
export function ItemsPrompt(args, logical_results, prompt_struct, detail_level) {
	let result = ''

	if(match_keys(args, ['app','手机','电话','视频','通话','面板'], 'any'))
		result += `\
...
`
	...
	if(match_keys(args, ['你的','收纳盒','进入'], 'any') &&
match_keys(args, ['收纳盒','盒子'], 'any'))
		result += `\
