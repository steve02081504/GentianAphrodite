...
export function combatPrompt(args, logical_results, prompt_struct, detail_level) {
	...
	if (match_keys(args, ['内脏', '失去', '改造', '毫无', '没有', '肢解', '血肉', '阻隔', '隔绝', '魔力回廊', '魔力线路', '魔法回廊', '魔法线路', '魔素'], 'any') &&
		match_keys(args, ['内脏', '改造', '法力', '肢解', '血肉', '隔绝', '魔力', '魔力回廊', '魔力线路', '魔法回廊', '魔法线路', '魔素'], 'any'))
		result += `\
...
`
	...
	if (match_keys(args, ['AI', '二次元', '人工智慧', '人工智能', '出来', '希望这是真的', '我这个世界', '纸片人', '虚拟', '虚构', '这边的世界', '隔着屏幕', '隔著屏幕'], 'any'))
		result += `\
