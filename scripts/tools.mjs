 ...
 * @param {Array} a - 第一个数组。
 * @param {Array} b - 第二个数组。
 * @return {boolean} - 如果数组相等则返回 true，否则返回 false。
 */
 ...
 * @return {boolean} - 如果目录被成功清理，则返回 true，否则返回 false。
 */
 ...
 * @return {string} - 替换了 Unicode 转义序列的字符串。
 */
